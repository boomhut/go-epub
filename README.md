...
---
# go-epub
go-epub is a Go library for creating EPUB files programmatically. It provides a simple interface for adding chapters, images, stylesheets, and metadata to an EPUB file.

### Features
- [Documented API](https://godoc.org/github.com/boomhut/go-epub)
